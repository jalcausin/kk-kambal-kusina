...
<html>
<head>
<title>Sign-Up Page - Kambal Kusina</title>
<link rel="stylesheet" type="text/css" href="css/signupPageStyles.css">
<link
...
<script>
	function validateForm() {
		...
		var confirmpassword = document.forms["registerForm"]["cpwd"].value;
...
<body>
	<div class="signupContainer">
		<div class="login-content">
			<form name="registerForm" method="post" action="signup"
				onSubmit="return validateForm()">
				<h2 class="title">Sign Up</h2>
				<div class="input-div fName">
					<div class="div">
						<h5>First Name</h5>
						<input type="text" class="input" name="fname" autocomplete="off" required>
					</div>
				</div>
				<div class="input-div lastName">
					<div class="div">
						<h5>Last Name</h5>
						<input type="text" class="input" name="lname" autocomplete="off" required>
					</div>
				</div>
				...
				<p style="color: #E39871">Passsword must contain at least one
				...
				<div class="input-div confPass">
					<div class="div">
						<h5>Confirm Password</h5>
						<input type="password" class="input" id="cpwd" name="cpwd"
							pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
							title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
					</div>
				</div>
				<div>
					<p style="color: Black;">
						<span><input type="checkbox" required></span> I accept the
						<a id="myBtn" href="#">TERMS OF USE and PRIVACY POLICY </a>
					</p>
				</div>
				<input type="submit" class="btn" value="Sign Up">
				<p style="color: Black;">
					Already have an account?<a href="loginPage.jsp">Log in here</a>
				</p>
			</form>
		</div>
	</div>
	...
	<div id="myModal" class="modal">
		<div class="modal-content">
			...
			<ul>
				...
				<li>
					<p>
						<strong>Company</strong> refers to Kambal Kusina, Queen's Row East
				...
				<li>
					<p>
						<strong>Website</strong> refers to Kambal Kusina, accessible from
						<a href="www.kambalkusina.com" rel="external nofollow noopener"
							target="_blank">www.kambalkusina.com</a>
					</p>
				</li>
				<li>
					<p>
			...
			<ul>
				...
				<li><strong>Flash Cookies.</strong> Certain features of our
					...
					settings as those used for Browser Cookies. For more information on
					how You can delete Flash Cookies, please read &quot;Where can I
			...
			<p>Our Service does not address anyone under the age of 13. We do
			...
			<p>If you have any questions about this Privacy Policy, You can
				contact us:</p>
			<ul>
				<li>By email: kambalkusinaregister@gmail.com</li>
			</ul>
		</div>
	</div>
	<script type="text/javascript" src="js/signupmain.js">
	</script>
    ...
    var msg = "<%=message%>";
    if (msg == "null") {
    	var msg1 = "Welcome to Kambal Kusina"
    	alert(msg1)
    } else {
    	alert(msg);
    }
